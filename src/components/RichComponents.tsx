  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
      {skillCategories.map((cat, idx) => (
        <div key={idx} className="bg-slate-900/50 border border-slate-700 p-4 rounded-lg hover:border-accent/50 transition-colors">
          ...
          <div className="flex flex-wrap gap-2">
            {cat.skills.map((skill, sIdx) => (
              <span key={sIdx} className="px-2 py-1 bg-slate-800 text-xs text-slate-300 rounded font-mono border border-slate-700">
                {skill}
              </span>
            ))}
          </div>
...
export const ContactComponent: React.FC = () => {
  return (
    <div className="bg-slate-900/50 border border-slate-700 p-6 rounded-lg my-4 max-w-md">
      <h3 className="text-lg font-bold text-white mb-4 border-b border-slate-700 pb-2">Contact Information</h3>
...
export const AboutComponent: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row gap-6 items-center bg-slate-900/30 p-6 rounded-xl border border-slate-800 my-4">
      ...
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Patrick Brösamle</h2>
...
export const ProjectsComponent: React.FC = () => {
  return (
    <div className="my-4 space-y-4">
      ...
      <div className="bg-slate-900/50 border border-slate-700 p-4 rounded-lg">
        <div className="flex justify-between items-start">
          <h3 className="font-bold text-white">Portfolio Terminal</h3>
